...
@section('konten')
    ...
    <form action="{{ route('education.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text"
              class="form-control form-control-sm" name="info_1" id="info_1" aria-describedby="helpId" placeholder="Nama Fakultas" value="{{ Session::get('info_1') }}">
          </div>
          <div class="mb-3">
            <label for="info_2" class="form-label">Nama Prodi</label>
            <input type="text"
              class="form-control form-control-sm" name="info_2" id="info_2" aria-describedby="helpId" placeholder="Nama Prodi" value="{{ Session::get('info_2') }}">
          </div>
          <div class="mb-3">
            <label for="info_3" class="form-label">IPK</label>
            <input type="text"
              class="form-control form-control-sm" name="info_3" id="info_3" aria-describedby="helpId" placeholder="IPK" value="{{ Session::get('info_3') }}">
          </div>
          <div class="mb-3">
            <div class="row">
                ...
                <div class="col-auto">
                    <input type="date" class="form-control form-control-sm" name="tgl_selesai" placeholder="dd/mm/yyy" value="{{ Session::get('tgl_selesai') }}">
                </div>
            </div>
          </div>
